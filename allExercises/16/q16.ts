...
let guestList:string[] = ["Hamza", "Daniyal", "Usman", "Farhan", "Aamir"];
...
let addingNewGuest = guestList.unshift("Salman");
...
let newGuestMiddle = guestList.splice(Math.floor(guestList.length/2),0,"Umair");
